# ruby_oop-school-library_m4_w3

![Microverse](https://img.shields.io/badge/Microverse-blueviolet)

"Ruby OOP school library" is  a tool to record what books are in the library and who borrows them. The app  allow you to:
...
```cmd
git clone  https://github.com/Metsanpeitto/ ruby_oop-school-library_m4_w3.git
cd ./ ruby_oop-school-library_m4_w3
```
